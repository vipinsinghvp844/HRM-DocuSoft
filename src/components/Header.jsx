          ...
          <div className="flex items-center gap-6 ml-auto">
            ...
            <div className="relative">
              ...
              {showPopup && (
                <div
                  ref={popupRef}
                  className="absolute right-0 mt-2 w-72 bg-white rounded-2xl shadow-2xl border border-gray-100 p-4 z-50 transform transition-all duration-300 ease-in-out"
                >
                  <button
                  ...
                  <div className="flex flex-col items-center mt-1">
                    <div className="relative group">
                      <img
                        src={loginUserProfile || placeholderImage}
                        alt="Profile"
                        className="w-24 h-24 rounded-full border-2 border-gray-200 shadow-lg group-hover:border-blue-400 transition-all duration-300"
                      />
                      <div className="absolute inset-0 rounded-full bg-blue-500 bg-opacity-0 group-hover:bg-opacity-10 transition-all duration-300"></div>
                    </div>
                  ...
                  <div className=" space-y-3">
                    <Link
                      ...
                      className="block text-center py-2.5 px-4 rounded-xl text-blue-600 hover:bg-blue-50 font-semibold transition-all duration-200 hover:shadow-md hover:scale-[1.02] active:scale-[0.98]"
                    >
                    ...
                    <button
                      ...
                      className="w-full py-2.5 rounded-xl bg-gradient-to-r from-red-500 to-red-600 text-white font-semibold hover:from-red-600 hover:to-red-700 transition-all duration-300 hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98]"
                    >
